...
with(hpc, plot(Global_active_power ~ Date_time, type = "l", xlab = "",
...
with(hpc, plot(Voltage ~ Date_time, type = "l", xlab = "datetime",
               ylab = "Voltage"))

with(hpc, plot(Global_reactive_power ~ Date_time, type = "l", xlab = "datetime",
